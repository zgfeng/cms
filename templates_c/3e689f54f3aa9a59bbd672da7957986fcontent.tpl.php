...
<table cellspacing="0" class="content">
	...
	<tr><td>作　　者：<input type="text" value="<?php echo $this->_vars['author'];?>" name="author" class="text" /> ( * 作者10位之内)</td></tr>
...
<table cellspacing="0" class="content">
	<tr><th><strong>发布一条新文档</strong></th></tr>
	<tr><td>文档标题：<input type="text" name="title" value="<?php echo $this->_vars['titlec'];?>" class="text" /> <span class="red">[必填]</span> ( * 标题2-50字符之间)</td></tr>
	<tr><td>栏　　目：<select name="nav"><option value="" style="padding:0;">请选择一个栏目类别</option><?php echo $this->_vars['nav'];?></select> <span class="red">[必选]</span></td></tr>
	...
	<tr><td>关 键 字：<input type="text" name="keyword" value="<?php echo $this->_vars['keyword'];?>"  class="text" /> ( * 每个关键字用','隔开，总长30位之内)</td></tr>
	...
	<tr><td>作　　者：<input type="text" value="<?php echo $this->_vars['author'];?>" name="author" class="text" /> ( * 作者10位之内)</td></tr>
	<tr><td><span class="middle">内容摘要：</span><textarea name="info"><?php echo $this->_vars['info'];?></textarea> <span class="middle">( * 内容摘要200之内)</span></td></tr>
